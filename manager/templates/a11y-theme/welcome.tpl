...
<div class="dashboard-block dashboard-block-[[+size]] [[+class:notempty=`[[+class]]`]]" aria-labelledby="wt1">
	...
	<p>
	<span id="toggle-dyslexia" onclick="dyslexiaToggler()" class="x-btn x-btn-small x-btn-icon-small-left primary-button x-btn-noicon" style="width: auto;"><em class=""><button type="button" id="toggle-dyslexia-text" class="x-btn-text">Enable</button></em></span>	
	</p>
	</div>
</div>	
<!--{$dashboard}-->
